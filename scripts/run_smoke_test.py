...
from src.environment import EnvironmentConfig, create_environment
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--environment-config",
        type=Path,
        default=Path("configs/environment.yaml"),
    )
...
def main() -> int:
    ...
    environment_config = EnvironmentConfig.from_mapping(
        resolve_configuration(args.environment_config).values
    )
